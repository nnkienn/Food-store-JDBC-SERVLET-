	...
	<div id="page-content" class="page-content">
		<div class="banner">
			<div class="jumbotron jumbotron-bg text-center rounded-0"
				style="background-image: url('includes/assets/img/bg-header.jpg');">
				<div class="container">
						...
						<div class="holder">
							...
							<div class="form-check-inline">
								<label class="form-check-label"> <input
									...
									id="exampleRadios1" value="option1" checked> Direct
									Bank Transfer
								</label>
							</div>
							<div class="form-check-inline">
								<label class="form-check-label"> <input
									class="form-check-input" type="radio" name="exampleRadios"
									id="exampleRadios2" value="option2"> Credit Card
								</label>
							</div>
						</div>
						<p class="text-right mt-3">
							<input checked="" type="checkbox"> I’ve read &amp; accept
							the <a href="#">terms &amp; conditions</a>
						</p>
						<a href="#" class="btn btn-primary float-right">PROCEED TO
